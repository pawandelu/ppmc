...
const Hero = () => {
  return (
    <section className="min-h-202.5 bg-[url('/assets/image/hero-bg.webp')] bg-center bg-no-repeat bg-cover relative">
      <img
        src="/assets/image/frog.webp"
